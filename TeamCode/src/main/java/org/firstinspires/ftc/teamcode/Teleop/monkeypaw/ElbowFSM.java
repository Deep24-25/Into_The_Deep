...
public class ElbowFSM {
    ...
    public static double HOVERING_LOWER_LIMIT = 170;
    public static double HOVERING_UPPER_LIMIT = 170;
    ...
    public static double HIGH_CHAMBER_DEPOSIT_FLEXED_POS_TELE = 80;
