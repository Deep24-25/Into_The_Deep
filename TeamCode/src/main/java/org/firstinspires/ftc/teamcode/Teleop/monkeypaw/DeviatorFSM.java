...
public class DeviatorFSM {
    ...
    public static  double RIGHT_DEVIATED_POS = 167.55;
    public static  double LEFT_DEVIATED_POS = 257.55;
    public static  double RELAXED_POS = 308.85;
    public static double VERTICAL_POS = 205.9;
