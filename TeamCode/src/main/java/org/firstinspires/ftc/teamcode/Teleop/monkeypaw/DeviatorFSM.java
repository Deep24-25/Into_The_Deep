...
public class DeviatorFSM {
    ...
    public static double RELAXED_POS = 150;
    public static double VERTICAL_POS = 250;
    ...
    private final double[] deviations = {RELAXED_POS, 145.5, LEFT_DEVIATED_POS, 100.5, VERTICAL_POS, 43, RIGHT_DEVIATED_POS, 20, 0, 200};
    ...
    public boolean VERTICALED() {
        return state == DeviatorStates.VERTICALED;
    }
