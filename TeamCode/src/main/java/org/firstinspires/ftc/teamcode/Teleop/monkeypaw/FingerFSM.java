...
public class FingerFSM {
    ...
    public static double SAMPLE_GRIPPED_POS = 0.2;
    public static double SPECIMEN_GRIPPED_POS = 0.199;
    public static double SAMPLE_RELEASED_POS = 0.67;
    public static double SPECIMEN_RELEASED_POS = 0.669;
