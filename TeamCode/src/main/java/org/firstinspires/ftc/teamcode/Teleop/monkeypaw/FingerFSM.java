...
public class FingerFSM {
    ...
    public static double SAMPLE_GRIPPED_POS = 0.471;
    public static double SPECIMEN_GRIPPED_POS = 0.47;
    public static double SAMPLE_RELEASED_POS = 0.851;
    public static double SPECIMEN_RELEASED_POS = 0.85;
